...
void main() {
  group('LoginConfig Tests', () {
    ...
    test('should remove trailing slash from base URL', () {
      ...
      expect(
          LoginConfig.instance.loginUrl, 'https://api.example.com/auth/login');
    });
    ...
    test('should add custom headers', () {
      ...
      expect(headers['Content-Type'],
          'application/json'); // Default header should still be there
    });
    ...
    test('should set timeout duration', () {
      ...
      expect(LoginConfig.instance.timeout,
